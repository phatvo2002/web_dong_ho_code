<section class="login-container">
             <div class="box-login">
                <h1 class="login-header">Cập nhật tài khoản</h1>
                <?php 
                ...
                <form action="index.php?act=dangki" method="post">
                    <div class="login-input"><i class="fa-solid fa-user"></i> <input type="text" name="username" id="name" placeholder="Tên Đăng Nhập" required value="<?=$username?>">
                      <span style="margin-left: 30px;color: red;" id="checkname">*</span>
                   </div>
                    <div class="login-input"><i class="fa-solid fa-envelope"></i></i> <input type="email" name="email" id="email" placeholder="Email" required value="<?=$email?>">
                       <span style="margin-left: 30px;color: red;" id="checkmail">*</span>
                   </div>
                   <div class="login-input"><i class="fa-solid fa-envelope"></i></i> <input type="số điện thoại" name="number" id="number" placeholder="Số điện thoại" required value="<?=$number?>">
                    ...
                    <input type="submit" value="Cập Nhật tài khoản" name="capnhat" class="input-submit" onclick="checkform();">
